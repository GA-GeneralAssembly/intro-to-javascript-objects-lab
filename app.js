...
const game = {
  party: [], //Pokemon that you have caught!
  
  //checkpoints placed throughout the game
  gyms: [
...
*/
game.party.push(pokemon[134], pokemon[112], pokemon[139], pokemon[150])
